...
declare function nlapiLoadSearch(fldnam: string, val: any): nlobjSearch;
 ...
 * @return
 */
declare function nlapiSendFax(from: any, to: string | number, subject: string, body: string, records: any, files: any): any;
 ...
 * @return
 */
declare function nlapiLoadFile(id: string | number): any;
 ...
 * @return
 */
declare function nlapiLogExecution(type: 'debug' | 'audit' | 'error' | 'emergency' | 'DEBUG' | 'AUDIT' | 'ERROR' | 'EMERGENCY', title: string, details?: string): any;
 ...
 * @return
 */
declare function nlapiScheduleScript(script: string | number, deployment?: string | number, parameters?: any): string;
 ...
 * @return
 */
declare function nlapiInitiateWorkflow(recordtype: string, id: any, workflowid: string | number): any;
 ...
 * @return
 */
declare function nlapiInitiateWorkflowAsync(recordType: any, id: any, workflowId: string | number, parameters: any): string;
 ...
 * @return
 */
declare function nlapiTriggerWorkflow(recordtype: string, id: any, workflowid: string | number, actionid: string | number, stateid: string | number): any;
...
declare interface nlobjSearchResultSet {
     ...
     * @return
     */
    forEachResult(callback: any): void
...
declare class nlobjSearchFilter {
    constructor(name: string, join: string, operator: string, value: any, value2?: string);
}
...
declare interface nlobjPortlet {
     ...
     * @return
     */
    addField(name: string, type: string, label?: string, source?: string | number): () => void;
...
declare interface nlobjForm {
     ...
     * @param {string} type field type
     * @param {string} [label] field label
     * @param {string, int} [radio] radio value for radio fields
     * @param {string} [tab] tab name that this field will live on. If empty then the field is added to the main section of the form (immediately below the title bar)
     * @return {nlobjField}
     *
     * @since 2008.2
     ...
     * @return
     */
    addField(name: string, type: string, label?: string, radio?: any, tab?: string): nlobjField;
...
declare interface nlobjAssistant {
     ...
     * @return
     */
    setScript(script: string | number): any;
     ...
     * @return
     */
    addField(name: string, type: string, label?: string, radio?: any, group?: string): () => void;
